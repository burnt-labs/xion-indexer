...
//   protoc               v4.24.4
// source: cosmos/authz/authz.proto

/* eslint-disable */
import * as _m0 from "protobufjs/minimal";
import { Any } from "../../google/protobuf/any/any";
import { Timestamp as Timestamp1 } from "../../google/protobuf/timestamp/timestamp";
import { Timestamp } from "../../google/protobuf/timestamp/timestamp";

export const protobufPackage = "cosmos.authz";
...
function toTimestamp(date: Date): Timestamp1 {
  const seconds = Math.trunc(date.getTime() / 1_000);
  const nanos = (date.getTime() % 1_000) * 1_000_000;
  return { seconds, nanos };
}

function fromTimestamp(t: Timestamp1): Date {
